 ...
 *
 * Note: in Lab1 challenge3, there are NCPU processes (one per hart).
 * current[hartid] points to the process currently running on each hart.
 */
...
// current[NCPU] points to the currently running user-mode application on each
// hart.
